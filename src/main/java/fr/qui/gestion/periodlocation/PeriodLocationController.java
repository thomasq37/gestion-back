...
public class PeriodLocationController {
    ...
    public ResponseEntity<PeriodLocation> mettreAJourUnePeriodePourAppartement(@PathVariable Long appartId, @PathVariable Long periodeId, @RequestBody PeriodLocation periodeMisAJour) {
        try {
    ...
    public ResponseEntity<String> supprimerUnePeriodePourAppartement(@PathVariable Long appartId, @PathVariable Long periodeId) {
        try {
